...
namespace top.ebiz.service.Models
{
    ...
    public class DocDetail3OutModel
    {
        ...
        public List<travelerList> traveler_list { get; set; } = new List<Models.travelerList>();
        public List<travelerSummaryList> traveler_summary { get; set; } = new List<Models.travelerSummaryList>();
        ...
        public List<DocFileListModel> docfile { get; set; } = new List<Models.DocFileListModel>();
