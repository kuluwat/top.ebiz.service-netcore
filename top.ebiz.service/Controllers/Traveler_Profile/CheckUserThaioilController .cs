...
public string Get(int id)
{
    return "value";
       ...
       [IgnoreAntiforgeryToken]
        [HttpPost("CheckUserThaioil", Name = "CheckUserThaioil")]
public IActionResult Post([FromBody]userNewList value)
        {
            ...
            mLog.module = "CheckUserThaioil";
            mLog.tevent = "CheckUserThaioil";
            mLog.ref_id = 0;
            ...
            Object result = service.AddUser(user,ref msg);
